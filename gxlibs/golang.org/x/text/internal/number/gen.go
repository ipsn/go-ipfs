...
import (
	...
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/gen"
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/language"
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/language/compact"
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/number"
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/stringset"
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/unicode/cldr"
)
...
func main() {
	...
	fmt.Fprintln(w, `import "github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/stringset"`)
