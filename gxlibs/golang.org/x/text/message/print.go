...
import (
	...
	"github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/format"
...
// It implements "github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/format".State.
