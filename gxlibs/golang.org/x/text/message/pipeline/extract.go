...
import (
	...
	fmtparser "github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/internal/format"
...
func (x *extracter) seedEndpoints() {
	pkg := x.prog.Package(x.iprog.Package("github.com/ipsn/go-ipfs/gxlibs/golang.org/x/text/message").Pkg)
